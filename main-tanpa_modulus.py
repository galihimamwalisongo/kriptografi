...
def header():
    print("Kriptografi Program Caesar Chiper Menggunkan Phython")
    print("Galih Imam Suwarso")
    print("2008096069")
    print("TI 4V")
def menu():
    while True:
...
def enkripsi():
    input_text = str(input("Masukan Text yang akan anda enkripsi, ex [imam] ? "))
    input_key = int(input("Masukan key/shift yang akan anda pakai, ex [angka] ? "))
    result = ""
